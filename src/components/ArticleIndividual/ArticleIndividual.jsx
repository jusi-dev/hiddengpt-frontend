...
class ArticleIndividual extends React.Component{
    render() {
        return (
            <div className='mr-8'>
                <div className='flex flex-col bg-neutral-100 p-4 ml-3 mr-1 mt-10 md:p-11 md:pl-20 md:mt-11 md:ml-28 md:mr-10 md:pr-20 rounded-md drop-shadow-lg w-full md:w-auto'>
                    <Helmet>
                        { this.props.gotAnswer === false
                            ?<title>Setup Bind9 on Ubuntu 22.04</title>
                            : <title>{this.props.userTitle}</title>
                        }
                    ...
                    <div>
                        { this.props.gotAnswer === false
                            ...
                            : <h1 className='font-bold text-3xl text-cyan-600'>{this.props.userTitle}</h1>
                        }
                    </div>
                    { this.props.gotAnswer === false 
                    ?
